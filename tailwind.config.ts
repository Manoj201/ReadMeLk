...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        sans: ['var(--font-latin-sans)', 'var(--font-sinhala-sans)', 'system-ui', 'sans-serif'],
        serif: ['var(--font-latin-serif)', 'var(--font-sinhala-serif)', 'Georgia', 'serif'],
        sinhala: ['var(--font-sinhala-sans)', 'sans-serif'],
      },
      keyframes: {
        'accordion-down': {
          from: { height: '0' },
